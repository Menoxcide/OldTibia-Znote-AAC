...
if (!empty($_POST['buy'])) {
	if ($user_znote_data['points'] >= $buy['points']) {
		?><td>You have <?php echo (int)($user_znote_data['points'] - $buy['points']); ?> points available. &nbsp;&nbsp;&nbsp;&nbsp; <a href="buypoints.php"><input class="button" type="submit" value="Buy Points"></a></td><?php
	} else {
		?><td>You have <?php echo $user_znote_data['points']; ?> points available. &nbsp;&nbsp;&nbsp;&nbsp; <a href="buypoints.php"><input class="button" type="submit" value="Buy Points"></a></td><?php
	}
} else {
	?><td>You have <?php echo $user_znote_data['points']; ?> points available. &nbsp;&nbsp;&nbsp;&nbsp; <a href="buypoints.php"><input class="button" type="submit" value="Buy Points"></a></td><?php
}
...
<table>
	<tr class="yellow">
		...
		if ($config['shop']['showImage']) echo '<td><center><img src="http://'. $config['shop']['imageServer'] .'/'. $offers['itemid'] .'.'. $config['shop']['imageType'] .'" alt="img"></center></td>';
		echo '<td>'. $offers['describtion'] .'</td>';
		echo '<td><center>'. $offers['points'] .'</center></td>';
		echo '<td>';
		?><center>
		<form action="" method="POST">
			<input type="hidden" name="buy" value="<?php echo (int)$key; ?>">
			<input type="submit" value="  PURCHASE  "  class="button needconfirmation" data-item-name="<?php echo $offers['describtion']; ?>" data-item-cost="<?php echo $offers['points']; ?>">
		</form></center>
		<?php
		echo '</td>';
		echo '</tr>';
